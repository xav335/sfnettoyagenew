    ...
    <tr class="template-download fade">
        ...
        <td>
            {% if (file.deleteUrl) { %}
				...
				<button class="btn btn-success import" data-type="IMPORT" data-url="{%=file.deleteUrl%}"{% if (file.deleteWithCredentials) { %} data-xhr-fields='{"withCredentials":true}'{% } %}>
                    <i class="glyphicon glyphicon-upload"></i>
                    <span>Importer</span>
                </button>
            {% } else { %}
