	           			...
	           			<ul class="nav navbar-nav">
	           				<li class="dropdown">
					          	...
					          	<ul class="dropdown-menu" role="menu">
					            	<li><a href="/admin/categorie/liste.php">Catégories</a></li>
					          		<li class="divider"></li>
					            	<li><a href="/admin/produit/edition.php">Ajout Produits</a></li>
					            	<li><a href="/admin/produit/liste.php">Modif / Suppr</a></li>
					          	</ul>
					        </li>
	           				<li class="dropdown">
